  ...
  return (
        <div className={classes.grid}>
          <a href="https://nextjs.org/docs" className={classes.card}>
            <h2 className={classes.tittle}>Documentation &rarr;</h2>
          ...
          <a href="https://nextjs.org/learn" className={classes.card}>
            <h2 className={classes.tittle}>Learn &rarr;</h2>
          ...
          >
            <h2 className={classes.tittle}>Examples &rarr;</h2>
          ...
          <a
            ...
            className={classes.card}
          >
            <h2 className={classes.tittle}>Deploy &rarr;</h2>
